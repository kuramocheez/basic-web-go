...
func main() {
	http.HandleFunc("/notes", GetData)
	http.HandleFunc("/notes/tambah-data", PostData)
	http.HandleFunc("/notes/ubah-data", UpdateData)
	http.HandleFunc("/notes/hapus-data", DeleteData)
